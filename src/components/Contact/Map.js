...
const Content = styled(ContentPosed)`
  ...
  .map-image {
    ...
    width: 100%;
    height: auto;
    background: url(${(props) => props.mapImage});
    object-fit: cover;
  }
  ...
  .map-panel {
    ...
    &__route {
      ...
      a {
        ...
        box-shadow: 0 2px 1px -1px rgba(0, 0, 0, 0.95);
        &:hover {
          color: lightgrey;
        }
      }
      ...
      <Content mapImage={mapImage}>
        ...
        <div className="map-panel">
          <div className="map-panel__route">
            ...
            <a
              href="https://www.google.com/maps/dir//52.3023435,-0.6955347/@52.3026524,-0.6926838,16.25z"
              target="_blank"
          ...
          <button className="map-panel__button" onClick={closeModal}>
            Close Map
          </button>
        </div>
      </Content>
